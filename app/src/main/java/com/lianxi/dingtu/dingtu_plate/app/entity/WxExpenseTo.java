...
public class WxExpenseTo implements Serializable {

    private ExpenseDetail expenseDetail;
    private List<ListEMGoodsDetail> listEMGoodsDetails;
    private ThirdPartyExpense thirdPartyExpense;
    ...
    public List<ListEMGoodsDetail> getListEMGoodsDetails() {
        return listEMGoodsDetails;
    }

    public void setListEMGoodsDetails(List<ListEMGoodsDetail> listEMGoodsDetails) {
        this.listEMGoodsDetails = listEMGoodsDetails;
    }

    public ThirdPartyExpense getThirdPartyExpense() {
        return thirdPartyExpense;
    }

    public void setThirdPartyExpense(ThirdPartyExpense thirdPartyExpense) {
    ...
    public static class ListEMGoodsDetail {
        /**
         * "Id": "00000000-0000-0000-0000-000000000000",
    ...
    public static class ThirdPartyExpense {
        /**
         *   "Id": "00000000-0000-0000-0000-000000000000",
         *       "DeviceType": 1,
         *       "DeviceId": 0,
