 ...
 */
@ActivityScope
public class WritePlateModel extends BaseModel implements WritePlateContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public WritePlateModel(IRepositoryManager repositoryManager) {
        super(repositoryManager);
    }

    @Override
    public Observable<BaseResponse<List<EMGoodsTypeTo>>> onEmGoodsTypeTo(String state) {
        return mRepositoryManager.obtainRetrofitService(UserService.class).getEMGoodsType(state);
    }
