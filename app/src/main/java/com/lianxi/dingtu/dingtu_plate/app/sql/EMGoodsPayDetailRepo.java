...
public class EMGoodsPayDetailRepo {
    ...
    public void delete(Sql_EMGoodsPayDetail emGoodsPayDetail) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        int id = emGoodsPayDetail.getId();
        Log.e("update", "update:id " + id);
        int a = db.delete(Sql_EMGoodsPayDetail.TABLE_NAME, Sql_EMGoodsPayDetail.KEY_ID + "=?", new String[]{String.valueOf(id)});
        db.close();
    }
