...
//                setResult(RESULT_OK, intent);
                SpUtils.put(SerialPortList.this, AppConstant.Print.SERIALPORTPATH,path);
                SpUtils.put(SerialPortList.this, AppConstant.Print.SERIALPORTBAUDRATE,selectBaudrate);
                finish();
            }
        });
    }
